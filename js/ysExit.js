(function ($) {
    ...
    $.fn.ysExit = function (o) {
        ...
        var defaults = {
            ...
            submitBt = document.querySelector(options.target + ' #submit'),
                ...
                attachEvents: function () {
                    ...
                    function submitpop(e) {
                        ...
                        if (email && name && check) {
                            ...
                            sendObj['email'] = email;
                            sendObj['check'] = check
                            cookies.set('email', JSON.stringify(sendObj));
                            pop.destroy();
                        }
                        else {
                    ...
                    submitBt.addEventListener('click', submitpop);
                    if (exitBt) {
                        exitBt.addEventListener('click', close);
                    }

                    if (element && options.closeOnOutsideClick) {
        ...
        var receivedObj = cookies.get('email')
